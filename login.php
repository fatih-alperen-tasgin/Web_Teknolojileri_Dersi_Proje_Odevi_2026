...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="card p-4 shadow-lg border-0 bg-secondary bg-opacity-10 text-white" style="max-width: 400px; width: 100%;">
        ...
        <form action="php/login_islem.php" method="POST" id="loginForm">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control bg-dark text-white border-secondary" id="kullanici" name="kullanici" placeholder="b2412100001@sakarya.edu.tr" required />
            </div>
            <div class="mb-3">
                <label for="sifre" class="form-label small fw-bold">Şifre (Öğrenci No)</label>
                <input type="password" class="form-control bg-dark text-white border-secondary" id="sifre" name="sifre" placeholder="b2412100001" required />
            </div>
